...
function Login() {
    ...
    return (
        <form onSubmit={(e) => { e.preventDefault(); handleLogin() }} className="bg-stripe-cross mx-6 px-8 pt-4 pb-8 border-2 border-base-content/20 rounded-box w-lg fieldset stripe-color-base-content/10">
